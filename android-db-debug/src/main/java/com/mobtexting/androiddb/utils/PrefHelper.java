...
public class PrefHelper {
    ...
    public static NetWorkResponse getAllPrefTableName(Context context) {
    ...
    public static UpdateRow addOrUpdateRow(Context context, String tableName,
        ...
        RequestRow rowDataKey = rowDataRequests.get(0);
        RequestRow rowDataValue = rowDataRequests.get(1);
    ...
    public static UpdateRow deleteRow(Context context, String tableName,
                                              List<RequestRow> rowDataRequests) {
        UpdateRow updateRowResponse = new UpdateRow();

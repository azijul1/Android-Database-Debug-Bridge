...
import com.mobtexting.androiddb.model.NetWorkResponse;
import com.mobtexting.androiddb.model.RequestRow;
import com.mobtexting.androiddb.model.TableDataResponse;
import com.mobtexting.androiddb.model.UpdateRow;
...
public class DatabaseHelper {
    ...
    public static NetWorkResponse getAllTableName(SQLiteDatabase database) {
    ...
    public static UpdateRow addRow(SQLiteDatabase db, String tableName,
                                   List<RequestRow> rowDataRequests) {
        UpdateRow updateRowResponse = new UpdateRow();
        ...
        for (RequestRow rowDataRequest : rowDataRequests) {
    ...
    public static UpdateRow updateRow(SQLiteDatabase db, String tableName, List<RequestRow> rowDataRequests) {
    ...
    public static UpdateRow deleteRow(SQLiteDatabase db, String tableName,
                                              List<RequestRow> rowDataRequests) {
